...
/**
 * A client-side analytics event captured by `EventTracker`.
 */
...
/**
 * A single numeric measurement recorded by `MetricCollector`.
 */
...
/** Aggregation functions supported by `MetricCollector.query`. */
export type AggregationType = 'sum' | 'avg' | 'min' | 'max' | 'count' | 'p50' | 'p95' | 'p99';

/**
 * A query over locally collected metric points.
 */
...
/**
 * Cinema revenue metrics for a reporting period.
 */
...
/**
 * Cinema occupancy metrics for a reporting period.
 */
